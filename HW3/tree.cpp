...
int countIncludes(const string a1[], int n1, const string a2[], int n2)
{
    ...
    // if we find a match, look fo all other matches in a1
    if (a2[0] == a1[0])
        // Case 1: count how many times a2 is contained in a1
        // Case 2: count how many times the rest of a2 is contained in a1
...
void order(string a[], int n)
{
    if (n <= 1)
        ...
        int firstNotLess, firstGreater = 0;
